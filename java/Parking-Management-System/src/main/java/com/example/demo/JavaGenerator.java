...
public class JavaGenerator {
    public static void main(String[] args){
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/parking_lot?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false&serverTimezone=GMT%2B8");
